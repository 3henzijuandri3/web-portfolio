...
const About = () => {
  return (
    <section name="About" className='w-full py-10 text-white bg-gradient-to-b from-gray-800 to-black-primary'>
        <div className='container flex flex-col w-full'>

          {/* About Judul */}
          <div className='mb-5'>
            <h1 className='pb-1 text-3xl font-bold border-b-2 border-gray-500 inline'> About </h1>
          </div>

          {/* About Content */}
          <div className='flex flex-col justify-center items-start gap-8 lg:flex-row'>
            ...
            <div className='w-full lg:w-[60%] xl:w-[70%]'>
              <p className='mb-4 text-base text-justify md:text-lg'>I am Henzi Juandri a fourth-year student at 
                <a href="https://telkomuniversity.ac.id/" className='pl-1 text-cyan-500'>Telkom University</a>
              ...
              <p className='mb-4 text-base text-justify md:text-lg'>
                ...
                <a href="https://grow.google/intl/id_id/bangkit/?tab=machine-learning" className='px-1 text-cyan-500'>Bangkit Academy led by Google, GoTo, & Traveloka - Android Learning Path</a> 
